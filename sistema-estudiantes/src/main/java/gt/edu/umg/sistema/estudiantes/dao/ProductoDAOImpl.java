...
public class ProductoDAOImpl implements ProductoDAO {
    ...
    public void guardar(Producto p) {
        ...
        try (Connection con = ConexionBD.getConexion();
            ...
            throw new RuntimeException(
                    "Error al guardar producto: " + e.getMessage(), e);
        }
    }
    ...
    public List<Producto> buscar(String codigo, String nombre) {
        ...
        try (Connection con = ConexionBD.getConexion();
            ...
            throw new RuntimeException(
                    "Error al listar productos: " + e.getMessage(), e);
        }
    ...
    public Producto buscarPorId(int id) {
        ...
        try (Connection con = ConexionBD.getConexion();
            ...
            throw new RuntimeException(
                    "Error al buscar producto: " + e.getMessage(), e);
        }
    }
    ...
    public void ajustarStock(int idProducto, TipoMovimiento tipo, int cantidad,
        ...
        try {
            ...
            throw new RuntimeException(
                    "Error al ajustar stock: " + e.getMessage(), e);
